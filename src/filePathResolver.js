...
const getModulePath_1 = require("./utils/getModulePath");
...
function filePathResolver(modules, knownPaths, pathPrefix = 'dist/') {
    ...
    return modules.map(i => {
        ...
        if (i.lookup) {
            ...
            moduleHierarchy = getModulePath_1.default(modules, i.id, knownPaths);
        }
        else {
        ...
        if (!filePath.startsWith(pathPrefix)) {
            let reversedGetModulePathMemory = reverseObject(getModulePath_1.getAllPathsToModule);
