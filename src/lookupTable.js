...
function lookupTableResolver(modules, knownPaths, entryPointModuleId, type = "browserify", pathPrefix = 'dist' + path.sep) {
    ...
    return modules.map(i => {
        return {
            ...
            filePath: getModuleLocation_1.default(modules, i, knownPaths, pathPrefix, /* appendTrailingIndexFilesToNodeModules: */ true, entryPointModuleId),
            code: i.code,
        };
    });
}
exports.lookupTableResolver = lookupTableResolver;
