...
const index_1 = require("../extern/replace-method/index");
// Browserify decoder
...
function browserifyDecoder(moduleArrayAST) {
    ...
    return moduleArrayAST.properties.map(moduleDescriptor => {
        ...
        index_1.replacer(moduleFunction)([requireFunctionIdentifier], // the function that require is in within the code.
...
exports.browserifyDecoder = browserifyDecoder;
