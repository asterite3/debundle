import { default as getModulePath, getAllPathsToModule as getModulePathMemory } from './utils/getModulePath';
...
export function filePathResolver(modules, knownPaths, pathPrefix = 'dist/') {
