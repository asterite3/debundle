...
const getModuleLocation_1 = require("./getModuleLocation");
...
it('should be able to get a module path generated by module id', () => {
    ...
    const output = getModuleLocation_1.default(modules, modules[0], knownPaths, pathPrefix);
...
it(`should do a lookup within another module (0) to determine a path to a given module (1)`, () => {
    ...
    const knownPaths = {};
    const pathPrefix = 'dist';
    const output = getModuleLocation_1.default(modules, modules[1], knownPaths, pathPrefix);
...
it(`should do a lookup within another module (0) where the looked up module (1) is a node_module`, () => {
    ...
    const output = getModuleLocation_1.default(modules, modules[1], knownPaths, pathPrefix, appendTrailingIndexFilesToNodeModules);
...
//# sourceMappingURL=getModuleLocation.spec.js.map