...
function makeModuleTree(modules, moduleId, tree = new Arboreal(), depth = 0) {
    ...
    for (let key in mod.lookup) {
        ...
        makeModuleTree(modules, mod.lookup[key], tree.children[tree.children.length - 1], ++depth);
    }
    return tree;
}
exports.default = makeModuleTree;
...
exports.printModuleTree = printModuleTree;
/* ['./foo'] => './foo'
 * ['../foo'] => '../foo'
 ...
 */
function getAllPathsToModule(tree, moduleId, knownPaths = {}, 
    ...
    tree.children.forEach(child => {
        ...
        if (child.children.length > 0) {
            let { completeEvents: ce, incompleteEvents: ie } = getAllPathsToModule(child, moduleId, knownPaths, newStack);
...
exports.getAllPathsToModule = getAllPathsToModule;
