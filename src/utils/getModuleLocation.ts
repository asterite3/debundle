import { default as makeModuleTree, getAllPathsToModule, printModuleTree } from './getModulePath';
import * as path from 'path';

// Given a module, return it's location on disk.
export default function getModuleLocation(modules, mod, knownPaths = {}, pathPrefix = 'dist' + path.sep,
    appendTrailingIndexFilesToNodeModules = false, entryPointModuleId = 1) {
    let moduleHierarchy;
    let modulePaths = [];
