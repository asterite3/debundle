...
export default function makeModuleTree(modules, moduleId, tree = new Arboreal(), depth = 0) {
...
export function printModuleTree(tree, maxDepth = 10) {
...
export function getAllPathsToModule(
    tree,
    moduleId,
    knownPaths = {},
